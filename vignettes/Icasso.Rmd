...
#### Using [BIODICA](https://github.com/LabBandSB/BIODICA)
...
```{r echo = FALSE, fig.align='center', out.height=562.5, out.width=499.5 ,fig.cap = 'Welcome screen of BIODICA with choice od funcitions and interface of fastICA data and parameters input'}
knitr::include_graphics("./figures-ext/BIODICAsc.png")
```
...
``` console 
java -jar BOIDICA.jar -config C:\Datas\BIODICA\config -outputfolder 
