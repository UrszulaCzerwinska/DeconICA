...
GE_SDY420 <- read.delim("../inst/data-raw/xCell_ImmPort/GE_SDY420.txt", row.names=1, stringsAsFactors=FALSE)
```
```{r eval = FALSE}
#import expression data
...
knitr::include_graphics("/Users/ulala/Documents/CURIE/R_code/DeconICA/vignettes/_MSTD_estimate.png ")
```
```{r echo = FALSE, fig.align='center', out.height='359.3px', out.width='433.3px'}
knitr::include_graphics("/Users/ulala/Documents/CURIE/R_code/DeconICA/vignettes/_AverageStability.png")
```
...
FACS_SDY420 <- read.delim("/Users/ulala/Documents/CURIE/R_code/DeconICA/inst/data-raw/xCell_ImmPort/FCS_SDY420.txt", row.names=1, stringsAsFactors=FALSE)
```
```{r eval = FALSE}
#import facs estimated proportions
...
knitr::include_graphics("./SDY420.comp.png")
```
